...
namespace structures
{
	...
	template<typename T>
	inline void LinkedList<T>::addFirst(const T& data)
	{
	...
	template<typename T>
	inline void LinkedList<T>::set(const T& data, const int index)
	{
	...
	template<typename T>
	inline T LinkedList<T>::getData(const int index)
	{
	...
	{
		LinkedListItem<T>* delItem = getItemAtIndex(size_ - 1);
		LinkedListItem<T>* prevItem = getItemAtIndex(size_ - 2);
